IF OBJECT_ID('@resultsDatabaseSchema.@outcome_cohort_table', 'U') IS NOT NULL 
DROP TABLE @resultsDatabaseSchema.@outcome_cohort_table;
CREATE TABLE @resultsDatabaseSchema.@outcome_cohort_table 
( 
...
DELETE FROM @resultsDatabaseSchema.@outcome_cohort_table where cohort_definition_id = @outcome_cohort_id;
INSERT INTO @resultsDatabaseSchema.@outcome_cohort_table (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)
select @outcome_cohort_id as cohort_definition_id, person_id, start_date, end_date 
